...
export class VtexGiftcardApiApi implements ICredentialType {
	name = 'N8nDevVtexGiftcardApiApi';

	displayName = 'vtex-giftcard-api API';

	icon: Icon = { light: 'file:../nodes/VtexGiftcardApi/vtex-giftcard-api.svg', dark: 'file:../nodes/VtexGiftcardApi/vtex-giftcard-api.dark.svg' };
	...
	properties: INodeProperties[] = [
		{
			...
			description: 'The base URL of your vtex-giftcard-api API server',
		},
		{
			displayName: 'API Key',
			name: 'apiKey',
